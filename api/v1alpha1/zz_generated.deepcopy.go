...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RateLimitService_RedisBackend) DeepCopyInto(out *RateLimitService_RedisBackend) {
	*out = *in
	if in.URL != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RateLimitService_RedisBackend.
func (in *RateLimitService_RedisBackend) DeepCopy() *RateLimitService_RedisBackend {
	if in == nil {
		return nil
	}
	out := new(RateLimitService_RedisBackend)
	in.DeepCopyInto(out)
	return out
}
