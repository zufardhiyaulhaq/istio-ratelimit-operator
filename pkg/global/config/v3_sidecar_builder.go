...
func NewV3SidecarBuilder(config v1alpha1.GlobalRateLimitConfig, version string) *V3SidecarBuilder {
...
func (g *V3SidecarBuilder) buildHttpFilterPatch() (*networking.EnvoyFilter_EnvoyConfigObjectPatch, error) {
...
func (g *V3SidecarBuilder) buildHttpFilterListener() (*networking.EnvoyFilter_ListenerMatch, error) {
...
func (g *V3SidecarBuilder) buildHttpFilterPatchValue() (string, error) {
...
func (g *V3SidecarBuilder) buildClusterPatch() (*networking.EnvoyFilter_EnvoyConfigObjectPatch, error) {
...
func (g *V3SidecarBuilder) buildClusterPatchValue() (string, error) {
