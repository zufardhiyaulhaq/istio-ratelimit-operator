...
func NewConfig1_8Builder(config v1alpha1.GlobalRateLimitConfig, ratelimit v1alpha1.GlobalRateLimit) *Config1_8Builder {
...
func (g *Config1_8Builder) buildName() string {
	return g.RateLimit.Name + "-1.8"
}

func (g *Config1_8Builder) buildHttpRoutePatch() (*networking.EnvoyFilter_EnvoyConfigObjectPatch, error) {
...
func (g *Config1_8Builder) buildHttpRouteConfiguration() (*networking.EnvoyFilter_RouteConfigurationMatch, error) {
...
func (g *Config1_8Builder) buildHttpRoutePatchValue() (string, error) {
