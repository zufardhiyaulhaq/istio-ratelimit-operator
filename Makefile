...
# zufardhiyaulhaq.com/istio-ratelimit-operator-bundle:$VERSION and zufardhiyaulhaq.com/istio-ratelimit-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= zufardhiyaulhaq.com/istio-ratelimit-operator
...
e2e.global.gateway.validate:
	...
	sleep 10
	python3 ./e2e/scripts/validate.py --domain podinfo.e2e.dev --path /api/v1/ --gateway
