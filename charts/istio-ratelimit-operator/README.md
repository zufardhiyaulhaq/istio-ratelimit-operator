...
helm install my-istio-ratelimit-operator istio-ratelimit-operator/istio-ratelimit-operator --version 2.10.0-rc.1 --values values.yaml
```
...
| operator.tag | string | `"v2.10.0-rc.1"` |  |
